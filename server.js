...
http.listen(3000, function () {
	...
	mongoClient.connect("mongodb+srv://admin:IThDbdu35kFCDhLt@cluster0.cne6wg7.mongodb.net/social?retryWrites=true&w=majority", function (error, client) {
		var database = client.db("social");
